...
<table class="table">
  ...
  <tbody>
	...
	foreach($resultset->result() as $result_row)
	{
		?>
    <tr>
      <th scope="row"><?php echo $result_row->category_id ?></th>
      <td><?php echo $result_row->name ?></td>
      <td><?php echo $result_row->discription ?></td>
      <td>                            
                <img src="<?php echo base_url(); ?>files/admin/category/<?php echo $result_row->image; ?>" width="40px">
</td>
	  <td>
      <!-- <a href="facebook.com">Edit</a> -->
      <a  data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->category_id ; ?>);" >Edit</a>

    <!-- | <a class=" confirm-delete" data-id="<?php echo $result_row->category_id ; ?>">Delete</a> -->

    <a href="<?php echo base_url('admin/manage_category/delete/'.$result_row->category_id );?>">Delete</a>
</td>
    </tr>
	<?php
	}	
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="box box-primary">
                                  <form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_category/create" enctype="multipart/form-data">
                                      <div class="box-body">
                                              ...
                                              <div class="form-group">
                                                          ...
                                                          <textarea class="form-control" id="txt_category_desc" name="txt_category_desc" rows="3"></textarea>
                                              </div>
                                              <div class="form-group">
                                                    <label>Image</label>
